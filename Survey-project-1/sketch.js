...
function setup() {
 ...
 // createSprite(submit.x, submit.y, 10, 10);
  ...
  title.html("Survey about Coronavirus");
  title.position(displayWidth/2 - 280, displayHeight/2  - 350);

  greeting = createElement('h2');
  greeting.html("<p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;  &nbsp;Hello! <br> The following is a survey about the COVID-19<br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </p>")
  greeting.position(displayWidth/2 - 280, displayHeight/2 - 230);

  question1 = createElement('h3', "Do you know what the novel Coronavirus is?");
  ...
  question2 = createElement('h3', "Have you travelled to any areas infected with this virus recently?");
  ...
  question3 = createElement('h3', "Have you been practicing social distancing? <br> (You should, it helps in prevention)");
  ...
  question4 = createElement('h3', "Do you know anyone who has symptoms / has COVID-19?");
